...
int main(void) {
	...
	ps2_init(PS2_BASE, USR_TIMER_BASE);
	ps2_ctxt ctxt = {PS2_BASE, USR_TIMER_BASE};
	alt_irq_register(PS2_IRQ, (void *) &ctxt, ps2_irq);
	alt_irq_register(USR_TIMER_IRQ, (void *) &ctxt, ps2_timer_irq);
