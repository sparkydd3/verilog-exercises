...
# Mon Oct 28 22:40:53 EDT 2019
# DO NOT MODIFY


# 
# avalon_vga_async "avalon_vga_async" v1.0
#  2019.10.28.22:40:53
# 
# 
...
set_module_property NAME avalon_vga_async
set_module_property VERSION 1.0
set_module_property INTERNAL false
set_module_property OPAQUE_ADDRESS_MAP true
set_module_property AUTHOR ""
set_module_property DISPLAY_NAME avalon_vga_async
...
set_fileset_property QUARTUS_SYNTH TOP_LEVEL avalon_vga_async
set_fileset_property QUARTUS_SYNTH ENABLE_RELATIVE_INCLUDE_PATHS false
add_fileset_file avalon_vga_async.v VERILOG PATH avalon_vga_async.v TOP_LEVEL_FILE
add_fileset_file fifo_async.v VERILOG PATH fifo_async.v
add_fileset_file vga_clk_sync.v VERILOG PATH vga_clk_sync.v
add_fileset_file vram_async_ctrl.v VERILOG PATH vram_async_ctrl.v
