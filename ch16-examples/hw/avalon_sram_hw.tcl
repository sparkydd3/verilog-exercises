...
add_fileset_file avalon_sram.v VERILOG PATH ../hw/avalon_sram.v TOP_LEVEL_FILE
...
set_interface_assignment cpu_ctrl embeddedsw.configuration.isMemoryDevice 1
